...
use etl::consumer::{process_read_batch, read_batch};
use eyre::Result;
use metrics::counter;
use etl::observability::{CONSUMER_BATCHES_PROCESSED, DLQ_MESSAGES_MOVED, DLQ_MOVES};
use etl::pipeline::{self as pipeline_mod, BatchKey, DlqPolicy};
use etl::pipeline::{ProcessProgressReporter, ShutdownHandle};
