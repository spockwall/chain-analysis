...
import { LogoIcon, ExplorerIcon, GroupsIcon, EtlIcon, DashboardIcon, AdminIcon, LabelsIcon, DatasetIcon } from "./NavIcons";
...
const NAV_TABS: Array<{
    ...
    { to: "/criminal-dataset", label: "Dataset", icon: <DatasetIcon /> },
